...
function install_complex_package() {
  ...
  function equal_complex(z1, z2) {
    console.log(111, z1, z2, real_part(z1));
...
// is_equal(make_rational(1, 2), make_rational(1, 2)); // true
// is_equal(make_rational(1, 2), make_rational(2, 3)); // false
// is_equal(1, 2); // false
is_equal(make_complex_from_real_imag(2, 1), make_complex_from_real_imag(2, 1)); // true
is_equal(make_complex_from_mag_ang(2, 1), make_complex_from_mag_ang(2, 2)); // false
