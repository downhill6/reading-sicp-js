...
// is_equal_to_zero(make_rational(0, 2)); // true
// is_equal_to_zero(make_rational(1, 2)); // false
// is_equal_to_zero(make_complex_from_mag_ang(1, 2)); // false
// is_equal_to_zero(make_complex_from_real_imag(0, 2)); // false
is_equal_to_zero(make_complex_from_real_imag(0, 0)); // true
