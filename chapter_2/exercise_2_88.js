...
const p1 = make_polynomial('x', list(make_term(2, 7), make_term(1, 4), make_term(0, 2)));
const p2 = make_polynomial('x', list(make_term(2, 3), make_term(1, 2), make_term(0, 1)));
...
display_list(sub(p1, p2)); // ["polynomial", ["x", [[2, [4, null]], [[1, [2, null]], [[0, [1, null]], null]]]]]
